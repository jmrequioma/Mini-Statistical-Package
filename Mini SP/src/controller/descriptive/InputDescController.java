package controller.descriptive;
	...
	public void confirm(ActionEvent event) throws IOException {
		...
		if (title.equals("")) {
			...
			if (MainFields.getType() == "Ungrouped") {
				...
				Parent root = FXMLLoader.load(getClass().getResource("/view/descriptive/InputData.fxml"));
				...
				MainFields.setTitle(title);
				Stage ownerStage = (Stage) stage.getOwner();
				Parent root = FXMLLoader.load(getClass().getResource("/view/descriptive/InputGrouped.fxml"));
				Scene scene = new Scene(root);
				scene.getStylesheets().add("/theme/bloodcrimson.css");
				ownerStage.setScene(scene);
				ownerStage.setResizable(false);
